...
%J = J +lambda/(2*m)*(sum(sum(reg_theta1(:,2:end)))+sum(sum(reg_theta2(:,2:end))));
...
del_3 = a_3-y_k; %5000x10

del_2 = (del_3*Theta2).*[ones(m,1),sigmoidGradient(z_2)]; %5000x26
del_2 = del_2(:,2:end);
delta_2 = 1/m*(del_3'*a_2);
delta_1 = 1/m*(del_2'*a_1);
